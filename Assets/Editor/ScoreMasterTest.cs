...
////
////    [Test]
////    public void T01AndyFixedList2 () {
////        int[] rolls = { 10, 3,4};
////        int[] fixedRolls = {0, 10,3,4};
////        Assert.AreEqual (fixedRolls.ToList(), ScoreMaster.FixedRolls (rolls.ToList()));
////    }
//
//    [Test]
...
//		int[] rolls = { 1,2, 3,4, 5,4, 3,2, 10, 1,3, 3,5};
//		int[] frames = {  3,   7,   9,   5, 14,   4,   8};
//		Assert.AreEqual (frames.ToList(), ScoreMaster.ScoreFrames (rolls.ToList()));
//	}
//
//	[Test]
